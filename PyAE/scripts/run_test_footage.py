# run_test_footage.py
# FootageItem テスト実行スクリプト
#
# After Effects の Python コンソールで実行:
#   exec(open(r"D:\works\VTechStudio\AfterFX\PyAE\scripts\run_test_footage.py").read())
...
print(f"\nFootageItem: {passed} passed, {failed} failed")
